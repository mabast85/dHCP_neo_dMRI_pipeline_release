...
m11=`avscale ${matrix} | grep -A 1 Rotation | tail -n 1| awk '{print $1}'`
m12=`avscale ${matrix} | grep -A 1 Rotation | tail -n 1| awk '{print $2}'`
m13=`avscale ${matrix} | grep -A 1 Rotation | tail -n 1| awk '{print $3}'`
m21=`avscale ${matrix} | grep -A 2 Rotation | tail -n 1| awk '{print $1}'`
m22=`avscale ${matrix} | grep -A 2 Rotation | tail -n 1| awk '{print $2}'`
m23=`avscale ${matrix} | grep -A 2 Rotation | tail -n 1| awk '{print $3}'`
m31=`avscale ${matrix} | grep -A 3 Rotation | tail -n 1| awk '{print $1}'`
m32=`avscale ${matrix} | grep -A 3 Rotation | tail -n 1| awk '{print $2}'`
m33=`avscale ${matrix} | grep -A 3 Rotation | tail -n 1| awk '{print $3}'`
